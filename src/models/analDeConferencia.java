...
public class analDeConferencia {
	...
	public String getTituloCongresso() {
		return tituloCongresso;
	}
	public void setTituloCongresso(String tituloCongresso) {
		this.tituloCongresso = tituloCongresso;
	}
